...
#Arreglo de entrada: python dia12/desafio4/recordatorios.py
...
# Revision calendario inicial
print("------ Calendario Inicial -------")
print("")
...
del trabajo.
4. Agregar cena de Navidad y de Año Nuevo cuando corresponda. Ambas a
las 22 hrs
...
# Salida de calnedario final
print("")
print("------ Nuevo Calendario -------")
print("")
for i in recordatorios:
    print(i)
print("")
print("------ Fin de Nuevo Calendario -------")