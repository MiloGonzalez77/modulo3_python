...
● El tiempo para estar lista serán 20 minutos + 2 minutos por cada ingrediente 
excluyendo masa y salsa.
6. Una opción que permita mostrar los ingredientes que actualmente tiene la pizza.
"""

#Modulo menus(sub_menus)
#Modulos: masa, salsas, ingredientes y tiempo. - Mediante Listas o diccionarios.
#Modulo extra para agregar y/o eliminar ingredientes. -funcion appen() - pop()

#Modulo tiempo: metodo len() para contar ingredientes seleccionados.
